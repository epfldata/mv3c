...
p=$2
numThr=$1
$CC -DOMVCC=true                        -DTPCC_TEST -DNUMTHREADS=$numThr -m64 -O3 $profile $store $attrib -DNUMWARE=$p -DCUCKOO=$cuckoo -DNDEBUG -DNUMPROG=$num  -Wno-attributes  -I $ROOT/util -I $ROOT/mv3c -I $ROOT/trading -I $ROOT/banking -I $ROOT/tpcc -I $ROOT/tpcc2 -std=c++11  $si -DCWW=false -DMALLOCTYPE=\"normal\" -o "mvccTPCC-$numThr-no-$p.out"  $ROOT/mainTPCC.cpp  -pthread -lcityhash 
$CC $ww -DCRITICAL_COMPENSATE=$critrex  -DTPCC_TEST -DNUMTHREADS=$numThr -m64 -O3 $profile $store $attrib -DNUMWARE=$p -DCUCKOO=$cuckoo -DNDEBUG -DNUMPROG=$num  -Wno-attributes  -I $ROOT/util -I $ROOT/mv3c -I $ROOT/trading -I $ROOT/banking -I $ROOT/tpcc -I $ROOT/tpcc2 -std=c++11  $si -DCWW=false -DMALLOCTYPE=\"normal\" -o "mv3cTPCC-$numThr-no-$p.out"  $ROOT/mainTPCC.cpp  -pthread -lcityhash 
$CC -DOMVCC=true                        -DTPCC_TEST -DNUMTHREADS=$numThr -m64 -O3 $profile $store $attrib -DNUMWARE=$p -DCUCKOO=$cuckoo -DNDEBUG -DNUMPROG=$num  -Wno-attributes  -I $ROOT/util -I $ROOT/mv3c -I $ROOT/trading -I $ROOT/banking -I $ROOT/tpcc -I $ROOT/tpcc2 -std=c++11  $si -DCWW=false -DMALLOCTYPE=\"jemalloc\" -o "mvccTPCC-$numThr-je-$p.out"  $ROOT/mainTPCC.cpp  -pthread -lcityhash -ljemalloc
$CC $ww -DCRITICAL_COMPENSATE=$critrex  -DTPCC_TEST -DNUMTHREADS=$numThr -m64 -O3 $profile $store $attrib -DNUMWARE=$p -DCUCKOO=$cuckoo -DNDEBUG -DNUMPROG=$num  -Wno-attributes  -I $ROOT/util -I $ROOT/mv3c -I $ROOT/trading -I $ROOT/banking -I $ROOT/tpcc -I $ROOT/tpcc2 -std=c++11  $si -DCWW=false -DMALLOCTYPE=\"jemalloc\" -o "mv3cTPCC-$numThr-je-$p.out"  $ROOT/mainTPCC.cpp  -pthread -lcityhash -ljemalloc
