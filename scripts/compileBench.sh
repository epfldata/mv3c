...
$CC -DCCSI -DNDEBUG -DBENCH -DSCALE=$p -DNUMTHREADS=$numThr -m64 -O3  -Wno-attributes  -I $ROOT/util -I $ROOT/mv3c -I $ROOT/trading -I $ROOT/banking -I $ROOT/tpcc -I $ROOT/tpcc2 -std=c++11  -o "bench-ccsi-$numThr-$p.out"  $ROOT/mainBench.cpp  -pthread -lcityhash -ltcmalloc_minimal
$CC -DCPI -DNDEBUG -DBENCH -DSCALE=$p -DNUMTHREADS=$numThr -m64 -O3  -Wno-attributes  -I $ROOT/util -I $ROOT/mv3c -I $ROOT/trading -I $ROOT/banking -I $ROOT/tpcc -I $ROOT/tpcc2 -std=c++11  -o "bench-cpi-$numThr-$p.out"  $ROOT/mainBench.cpp  -pthread -lcityhash -ltcmalloc_minimal
