...
public class ConcurrentContainsKeyTest {
  ...
  // Should be > ConcurrentSHMap.TREEIFY_THRESHOLD but small
  ...
  public void testContainsKey() {
    ...
    // Create map with an initial size >= ConcurrentSHMap.TREEIFY_THRESHOLD

    // ensuring tree'ification will occur for a small number of entries

    // with the same hash code

    ConcurrentSHMap<Object, Object> m = new ConcurrentSHMap<>(64);
  ...
  private static void test(X[] content, ConcurrentSHMap<Object, Object> m) {
  ...
  private static void testOnce(Object[] content, ConcurrentSHMap<Object, Object> m) {
